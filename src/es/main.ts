...
export class TaragnorSecurity {
	...
	static getResultsArray(roll: Roll) {
			return roll.terms
	...
	static verifyChatRoll(chatmessage: ChatMessage, html: JQuery<HTMLElement>,_c: unknown,_d: unknown) {
		const game = getGame();
